...
(function () {
  var CONFIG = {
    ...
    earlyBird: [
      { key: 'phase1', label: '1차 조기신청', labelEn: '1st Early Bird', end: '2026-09-30T23:59:59', discountRate: 0.20 },
      { key: 'phase2', label: '2차 조기신청', labelEn: '2nd Early Bird', end: '2026-10-31T23:59:59', discountRate: 0.10 }
    ],

    /* 3) 기존(직전) 참가업체 — 연속참가 할인 대상(본 행사 1회 이상 참여업체 10% 추가). */
    returningDiscountRate: 0.10,
    returningCompanies: [
      '범어사', '대구중구청', '드림스코프', '홍법사', '서퍼스크레이지', '아르반호텔스',
      'SMB웰니스', '비비비당', '빛으로', '한중건강관리협회', '고려의료관광개발',
      '부산시한의사회', '부산티엔씨', '동의과학대', '데스커', '부산경제진흥원',
      '메디캐디코리아', '바이오헬스', '부산일보', '부산관광공사', '대전의료관광',
      '광주메디뷰티산업전', '광주권의료관광', '메디펀', '부산서구', '부산진구',
      '유유외과의원', '다이트한의원', '뉴욕치과', '삼성리한여성의원', '덴타피아치과',
      '복음병원고신대', '동아대학교병원', '삼육부산병원', '포시즌성형외과', '새론의원',
      '라인업치과', '원자력병원동남권', '한국건강관리협회', '자연안에한의원', 'MC병원365',
      '부산대학교병원', '부산광역시', '누네빛안과', '더바디성형외과', '김병준레다스',
      '고운세상김양제', '의료재단은성', '해운대백병원', '인제대학교병원', '제이린병원',
      '이샘병원'
